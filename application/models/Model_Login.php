...
{
	var $table = 'skl_login';
	var $column_order = array('log_id', 'log_nama', 'log_user', 'log_level', 'log_skl_id'); //set column field database for datatable orderable
	var $column_search = array('log_id', 'log_nama', 'log_user', 'log_level', 'log_skl_id'); //set column field database for datatable searchable just firstname , lastname , address are searchable
